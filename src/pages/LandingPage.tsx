    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-md z-50 border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <Link 
            to="/login" 
            className="bg-brand-primary text-white px-6 py-2 rounded-full font-semibold hover:bg-sky-600 transition-colors"
          >
            Masuk
          </Link>
        </div>
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <span className="inline-block px-4 py-1.5 mb-6 text-sm font-semibold tracking-wide text-brand-primary uppercase bg-sky-50 rounded-full">
              Anti-Bullying Campaign
            </span>
            <h1 className="text-5xl md:text-7xl font-extrabold text-slate-900 mb-6 leading-tight">
              Bersama Hentikan <br />
              <span className="text-brand-primary">Tindakan Bullying</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link 
                to="/login" 
                className="w-full sm:w-auto bg-brand-primary text-white px-8 py-4 rounded-xl font-bold text-lg flex items-center justify-center gap-2 hover:bg-sky-600 transition-all shadow-lg shadow-sky-200"
              >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-brand-secondary/10 rounded-full flex items-center justify-center font-bold text-brand-secondary">1</div>
                  <div>
                ...
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-brand-secondary/10 rounded-full flex items-center justify-center font-bold text-brand-secondary">2</div>
                  <div>
                ...
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-brand-secondary/10 rounded-full flex items-center justify-center font-bold text-brand-secondary">3</div>
                  <div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-brand-secondary p-8 rounded-2xl text-white shadow-xl hidden md:block">
